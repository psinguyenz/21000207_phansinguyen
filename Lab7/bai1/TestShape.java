...
public class TestShape {
    public static void main(String args[]) {
        ...
        /*System.out.println(shape1.getRadius()); error no getRadius in Shape*/
        ...
        /*Shape shape2 = new Shape(); error Shape is abtract can't create*/
        ...
        /*System.out.println(shape3.getLength());error Shape don't have getLength*/
        ...
        /*System.out.println(shape4.getSide()); error Shape don't have getSide()*/

        Rectangle rectangle2 = (Rectangle)shape4;
        System.out.println(rectangle2);
        System.out.println(rectangle2.getArea());
        System.out.println(rectangle2.getColor());
        /*System.out.println(shape4.getSide()); error Rectangle don't have getSide()*/
