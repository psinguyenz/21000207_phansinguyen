...
public class PensionContributionCalculatorWithSentinel {
    public static void main(String args[])
    {
        ...
        while (salary != SENTINEL)
        {
            ...
            {
                employeeContribution = contributableSalary * EMPLOYER_RATE_65_AND_ABOVE;
                employerContribution = contributableSalary * EMPLOYER_RATE_65_AND_ABOVE;
            }
            totalContribution = employeeContribution + employerContribution;
            System.out.println("The employee's contribution is: $%.2f%n" + employeeContribution);
            System.out.println("The employer's contribution is: $%.2f%n" + employerContribution);
            System.out.println("The total contribution is: $%.2f%n" + totalContribution);
        System.out.print("Enter the monthly salary (or -1 to end): $");
        salary = in.nextInt();
        }
